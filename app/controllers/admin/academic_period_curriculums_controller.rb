class Admin::AcademicPeriodCurriculumsController < ApplicationController
  ...
  def create
    ...
    begin
      ActiveRecord::Base.transaction do
        ...
        if @academic_period_curriculum.errors.size > 0
          raise 'academic_period_curriculum'
        end
      end
      ...
      if e.message == 'professor_ids'
        ...
        flash[:alert] = t 'activerecord.errors.models.academic_period_curriculum.unknown'
      end
